 ...
 */
static int decrypt_byte(uLong* pkeys, const uLong* pcrc_32_tab)
{
 ...
 */
static int update_keys(uLong* pkeys,const uLong* pcrc_32_tab,int c)
{
 ...
 * the given password.
 */
static void init_keys(const char* passwd,uLong* pkeys,const uLong* pcrc_32_tab)
{
    *(pkeys+0) = 305419896L;
    *(pkeys+1) = 591751049L;
    *(pkeys+2) = 878082192L;
