...
- GUI.File browser: iOS 11+ File app integration enabled. You can copy files in the documents directory without iTunes or iFunBox with automatic reload of documents directory<br>
